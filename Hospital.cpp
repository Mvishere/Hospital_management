...
public:
    ...
    void getDetails()
    {
        ...
        cout << "No of rooms/beds available: " << this->beds << endl;
...
int main()
{
    ...
    Doctor M("Manas", 19, "isheremv@gmail.com", 8212412412, "ews", 'm', 21, "11/12/2024", 1000000, "orthopedics", "junior doctor");
    Patient p(1, "pratham", 19, "awda@gmail.com", 1234567891, "ews", 'm', "disease", "11/12/2024");
